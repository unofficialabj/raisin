        ...
        <div>
          <AnimateIn>
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-muted sm:text-lg">
              We design and deliver modern web platforms, mobile apps, and cloud-ready systems—
              combining strategy, engineering, and creative media so your business scales with
              confidence.
            </p>
