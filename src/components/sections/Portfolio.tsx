...
const projects = [
  {
    ...
    category: "Web",
    description:
      "Headless storefront with real-time inventory and personalized recommendations.",
    image:
  ...
  },
  {
    ...
    category: "Mobile",
    description:
      "Patient-first mobile experience with secure messaging and appointment scheduling.",
    image:
  ...
  },
  {
    ...
    category: "Web",
    description:
      "Executive dashboards with role-based access and exportable insights.",
    image:
  ...
  },
  {
    ...
    category: "EdTech",
    description:
      "Modular LMS with cohort tracking, assessments, and video delivery at scale.",
    image:
  ...
  },
  {
    ...
    category: "Marketing",
    description:
      "Integrated campaign site, content system, and performance marketing setup.",
    image:
  ...
  },
  {
    ...
    category: "Media",
    description:
      "Aerial photography and video pipeline for real estate and events.",
    image:
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <AnimateIn>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-muted">
            A snapshot of recent work—each engagement tailored to industry,
